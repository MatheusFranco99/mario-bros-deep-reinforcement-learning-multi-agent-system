...
def OurModel(input_shape, action_space):
    ...
    # model.summary
    # Q = Sequential()
    # Q.add(Dense(24,input_shape=input_shape,activation="relu"))
    # Q.add(Dense(24,activation="relu"))
    # Q.add(Dense(action_space,activation="linear"))
    # Q.compile(loss='mse',optimizer = Adam(learning_rate = 0.00025))
