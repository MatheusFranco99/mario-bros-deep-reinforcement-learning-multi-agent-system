...
def testModels(agent1,agent2,render=False,num_max_steps=10000):
...
def trainModels(num_max_steps,n_epochs = 100,jumpKSteps=3,render=False,):
    ...
    if(agent1 == 0):
        agent1 = Agent(84,84,4,18,1.0,32,fname=f'{args.file}_agent1.h5')
    if(agent2 == 0):
        agent2 = Agent(84,84,4,18,1.0,32,fname=f'{args.file}_agent2.h5')
